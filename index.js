...
const EN_DESCRIPTIONS = {
  ...
  pm_get_board: 'Get the Kanban board view (issues grouped by status columns).',
  pm_get_backlog: 'Get the backlog (unassigned issues not in any sprint).',
